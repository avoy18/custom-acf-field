...
if( !class_exists('AV_AN_acf_field_FIELD_NAME') ) :


class AV_AN_acf_field_FIELD_NAME extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('AN_INTEGRATION', 'TEXTDOMAIN');
...
// initialize
new AV_AN_acf_field_FIELD_NAME( $this->settings );
